...
<head>
    ...
    <title>Takalo-Takalo - Login (Admin)</title>
    ...
    <section id="reservation">
        <div class="reservation">
            <div class="reservation-left">
                <section class="heroAdmin">
                    ...
                    <div class="hero-content">
                        ...
                        <a href="/loginUser" class="cta-btn-loginAdmin">Access Account</a>
                    </div>
                </section>
            </div>
            ...
            <div class="register-right">
                ...
                <?php endif; ?>
                <form action="<?php echo Flight::get('flight.base_url'); ?>/register" method="POST">
                    ...
                    <button type="submit" class="submit-btn-loginAdmin" style="display:block;margin:20px auto 0;">Register</button>
                </form>
            </div>
        </div>
    </section>
<script src="/tooplate-bistro-scripts.js" nonce="<?php echo Flight::get('csp_nonce'); ?>"></script>
</body>
</html> 