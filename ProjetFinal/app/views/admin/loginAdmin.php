    ...
    <section id="reservation">
        <div class="reservation">
            <div class="reservation-left">
                ...
                <?php endif; ?>
                <form class="loginAdmin-form" action="<?php echo Flight::get('flight.base_url'); ?>/loginAdmin" method="POST">
            ...
            <div class="reservation-right">
                ...
                <section class="heroAdmin">
                    ...
                    <div class="hero-content">
                        ...
                        <a href="<?php echo Flight::get('flight.base_url'); ?>/loginUser" class="cta-btn-loginAdmin">Sign in with a standard user account</a>
                    </div>
                </section>
            </div>
        </div>
